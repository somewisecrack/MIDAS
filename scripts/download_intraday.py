...
OUTPUT_FILE = '/Users/rahulgirishkumar/TRADING/data/tickers_30m_ohlcv.csv'
INTERVAL = '30m'
PERIOD = '60d'
...
def main():
    ...
    if all_data:
        ...
        # Ensure column consistency with daily file if possible
        # Daily: Date,Open,High,Low,Close,Volume,Ticker,Adj Close
        # yfinance 30m: Datetime, Open, High, Low, Close, Adj Close, Volume, Ticker
        
        # Rename 'Datetime' to 'Date' for consistency if that's what's preferred, 
        # but usually intraday uses 'Datetime'
