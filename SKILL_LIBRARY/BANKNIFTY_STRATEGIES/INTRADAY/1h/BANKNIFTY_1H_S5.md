# BANKNIFTY_1H_S5: BANKNIFTY Intraday — SHORT 1-Year @ 1h
...
1. **≤1 BFSI stocks up [sector weakness]**  `bfsi_weak >= 1.0`
2. **SBIN down 0.3%+ [PSU weakness]**  `sbin_ret <= -0.003`
...
| OOS Win Rate | **75.3%** |
| OOS Trades | 81 |
| In-Sample Win Rate | 77.5% |
| OOS Cumulative Return | +13.2% |
