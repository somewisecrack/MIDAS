# NIFTY_S02: NIFTY Oversold Bounce — LONG 5d
...
1. **BB%B < 0.10 [near lower band]**  `bb_pct_raw <= 0.1`
2. **INR strengthened (FII inflows)**  `INR_ret >= 0.002`
...
| OOS Win Rate | **76.0%** |
| OOS Trades | 25 |
| In-Sample Win Rate | 77.4% |
| Avg Return per Trade | +2.02% |
| Binomial p-value | 0.0073 |
| ₹1L Simulation Final | ₹134,634 |
| Sim Win / Loss | 13 / 6 |
