# NIFTY_S04: NIFTY Mean-Reversion Short — SHORT 5d
...
1. **BB%B > 0.90 [near upper band]**  `bb_pct_raw >= 0.9`
2. **Month-end [sell the fact]**  `MONTH_END >= 1.0`
...
| OOS Win Rate | **81.0%** |
| OOS Trades | 21 |
| In-Sample Win Rate | 75.6% |
| Avg Return per Trade | +2.49% |
| Binomial p-value | 0.0036 |
| ₹1L Simulation Final | ₹130,804 |
| Sim Win / Loss | 9 / 5 |
